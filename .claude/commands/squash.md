...
| **PR 准备前** | 每个功能 1~2 个 commit | 便于 review |
| **合并后** | Squash merge | 主线保持干净 |
...
|------|------|
| **本地可以乱** | 开发时保持小 commit |
| **推送前整理** | PR 前合并为有意义的 commit |
| **主线干净** | 使用 squash merge 合并 PR |
| **保护共享分支** | 不要重写已推送的共享历史 |
| **沟通协作** | 团队约定 commit 整理策略 |

---

**小 commit 开发 → 整理后推送 → 干净的主线**
